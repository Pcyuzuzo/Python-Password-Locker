...
class TestAccount(unittest.TestCase):
    def setUp(self):
        ...
        self.new_account = Account("Patience","Cyuzuzo","4321","pcyuzuzo@gmail.com") # create Account object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_account.account_name,"Patience")
        self.assertEqual(self.new_account.user_name,"Cyuzuzo")
        self.assertEqual(self.new_account.password,"4321")
        self.assertEqual(self.new_account.email,"pcyuzuzo@gmail.com")
