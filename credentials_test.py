...
class TestCredentials(unittest.TestCase):
    def setUp(self):
        ...
        self.new_credentials = Credentials("Patience","Cyuzuzo","4321","pcyuzuzo@gmail.com") # create Account object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credentials.credentials_name,"Patience")
        self.assertEqual(self.new_credentials.usr_name,"Cyuzuzo")
        self.assertEqual(self.new_credentials.password,"4321")
        self.assertEqual(self.new_credentials.email,"pcyuzuzo@gmail.com")
